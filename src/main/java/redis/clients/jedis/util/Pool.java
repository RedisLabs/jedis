...
public class Pool<T> implements RedisObjectPool<T> {
    ...
    public void init(RedisObjectPoolConfig redisObjectPoolConfig, RedisObjectFactory redisObjectFactory) {
        initPool((GenericObjectPoolConfig) redisObjectPoolConfig, (PooledObjectFactory) redisObjectFactory);
    }
    ...
    public void setInternalPool(GenericObjectPool<T> internalPool) {
